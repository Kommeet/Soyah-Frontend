...
//     Uri.parse('https://soyah-go-wildflower-905-holy-morning-7136.fly.dev/api/check-in'), // Replace with your real URL
...
//     // Example list of network image URLs for matches (replace with your actual data)
...
//     // Example list of network image URLs for frequent visitors (replace with your actual data)
//     final List<String> frequentVisitorImages = [
//       'https://www.kasandbox.org/programming-images/avatars/marcimus-red.png',
//       'https://www.kasandbox.org/programming-images/avatars/marcimus-purple.png',
//       'https://www.kasandbox.org/programming-images/avatars/marcimus-orange.png',
//       'https://www.kasandbox.org/programming-images/avatars/marcimus.png',
...
//           // View Your Matches Section without Left Avatar, Scrollable Avatars on Right
//           Row(
//             mainAxisAlignment: MainAxisAlignment.spaceBetween,
//             children: [
//               Text(
...
//                     ),
//               ),
//               // Scrollable Avatars for View Your Matches
//               SizedBox(
...
//           // Frequent Visitors Section without Left Avatar, Scrollable Avatars on Right
//           Row(
//             mainAxisAlignment: MainAxisAlignment.spaceBetween,
//             children: [
//               Text(
...
//                     ),
//               ),
//               // Scrollable Avatars for Frequent Visitors
//               SizedBox(
//                 width: 150, // Adjust width to fit your design
//                 child: SingleChildScrollView(
//                   scrollDirection: Axis.horizontal,
...
class _SwipeableCardState extends State<SwipeableCard> {
  ...
  Future<void> _fetchFrequentVisitors() async {
    final response = await http.get(
      Uri.parse('https://soyah-go-wildflower-905-holy-morning-7136.fly.dev/api/frequent-visitors/${widget.place.placeId}'),
      headers: {'Content-Type': 'application/json'},
    );
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        frequentVisitorImages = visitors
            .where((visitor) => visitor['image'] != null && visitor['image'].isNotEmpty)
            .map((visitor) => visitor['image'] as String)
            .toList();
      });
    } else {
  ...
  Future<void> _checkIn(String placeId, String userId) async {
    final response = await http.post(
      Uri.parse('https://soyah-go-wildflower-905-holy-morning-7136.fly.dev/api/check-in'),
      headers: {'Content-Type': 'application/json'},
      body: jsonEncode({
        'place_id': placeId,
        'user_id': userId,
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 4),
                            const Icon(Icons.star, color: Color(0xFFFFCD29), size: 14),
                          ],
                        ),
                      ],
                    ),
  ...
  Widget _buildUserCard(BuildContext context) {
    ...
    // Example list of network image URLs for matches (unchanged)
    final List<String> matchImages = [
      'https://www.kasandbox.org/programming-images/avatars/marcimus-purple.png',
      'https://www.kasandbox.org/programming-images/avatars/marcimus-orange.png',
      'https://www.kasandbox.org/programming-images/avatars/marcimus.png',
            ...
            children: [
              ...
              SizedBox(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Row(
                    children: List.generate(
                      frequentVisitorImages.isNotEmpty ? frequentVisitorImages.length : 1,
                      (index) {
                        return Transform.translate(
                          offset: Offset(-10 * index.toDouble(), 0),
                          child: CircleAvatar(
